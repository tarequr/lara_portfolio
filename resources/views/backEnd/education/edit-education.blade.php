              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <h1 class="h4 text-gray-900 mb-4">Update Education!</h1>
                  </div>
                  <form class="user" method="POST" action="{{ route('education.update',$editData->id) }}" enctype="multipart/form-data" >
                     @csrf
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                         <input type="text" name="degree" class="form-control" value="{{ $editData->degree }}" placeholder="Enter your degree">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                         <input type="text" name="institution" class="form-control" value="{{ $editData->institution }}" placeholder="Enter your institution">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="submit" name="btn" class="btn btn-primary btn-user btn-block" value="Update Education Info">
                      </div>
                    </div>
                  </form>
                </div>
