              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <h1 class="h4 text-gray-900 mb-4">Update Experience!</h1>
                  </div>
                  <form class="user" method="POST" action="{{ route('experience.update',$editData->id) }}" enctype="multipart/form-data" >
                     @csrf

                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">Start Date<span class="text-danger">*</span></label>
                      <div class="col-sm-9">
                        <input type="date" name="start_date" class="form-control" value="{{ date('Y-m-d',strtotime($editData->start_date)) }}">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="date" name="end_date" class="form-control" value="{{ date('Y-m-d',strtotime($editData->end_date)) }}">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                         <input type="text" name="company_name" class="form-control" value="{{ $editData->company_name }}" placeholder="Enter your company name">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                         <input type="text" name="designation" class="form-control" value="{{ $editData->designation }}" placeholder="Enter your designation">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                         <input type="text" name="location" class="form-control" value="{{ $editData->location }}" placeholder="Enter your location">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="submit" name="btn" class="btn btn-primary btn-user btn-block" value="Update Experience Info">
                      </div>
                    </div>
                  </form>
                </div>
